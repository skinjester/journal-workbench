...
JIRA
- can my Jira user credentials be changed to [REDACTED_EMAIL]? 
    + Your email change request could not be processed because [REDACTED_EMAIL] is already associated with another Atlassian account.
